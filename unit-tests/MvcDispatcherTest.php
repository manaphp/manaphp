...
class MvcDispatcherTest extends TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_di->alias->set('@ns.controllers', 'App\\Test\\Controllers');
        $this->_di->remove($this->_di->alias->resolve('@ns.controllers\\Test1Controller'));
        $this->_di->remove($this->_di->alias->resolve('@ns.controllers\\Test2Controller'));
    }
