...
insert into `admin`(`admin_id`, `admin_name`, `status`, `type`, `tag`, `email`, `salt`, `password`, `login_ip`,
                    `login_time`, `session_id`, `creator_name`, `updator_name`, `created_time`, `updated_time`)
values (1, 'admin', 1, 1, 0, 'admin@qq.com', 'c5c05ae460905af4', 'ed2a1a4f62f1717ff30b2197a283cc22', '192.168.1.47', 0,
        'gz7ne3p9iwj15bm0sqehljpi0hscp0g2', '', 'admin', 0, 0);
...
insert into `bos_bucket`(`bucket_id`, `bucket_name`, `base_url`, `created_time`)
values (1, 'www', 'http://cdn.manaphp.d/', 0);
...
insert into `menu_group`(`group_id`, `group_name`, `icon`, `display_order`, `creator_name`, `updator_name`,
                         `created_time`, `updated_time`)
values (3, '权限管理', 'el-icon-caret-right', 0, 'admin', 'admin', 0, 0),
...
insert into `menu_item`(`item_id`, `item_name`, `group_id`, `display_order`, `url`, `icon`, `creator_name`,
                        `updator_name`, `created_time`, `updated_time`)
values (8, '角色权限', 3, 0, '/rbac/role_permission', 'el-icon-arrow-right', 'admin', 'admin', 0, 0),
...
insert into `rbac_role`(`role_id`, `role_name`, `display_name`, `enabled`, `permissions`, `creator_name`,
                        `updator_name`, `created_time`, `updated_time`)
values (1, 'admin', '超级管理员', 1, '', 'admin', 'admin', 0, 0),
